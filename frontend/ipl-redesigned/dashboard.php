...
<body>
	...
	<?php
		...
		if($conn){
			echo "<br><u><h3>SEASON WINNER</u><br><br>";
			echo "<table border='2px solid black' padding='20px'><th>Serial No.</th><th>Season</th><th>Winner</th>";
			$sql = "SELECT * FROM season_winner WHERE user_id='$uid'";
			...
			if(mysqli_num_rows($result) > 0){
				while($row = mysqli_fetch_assoc($result)){
					...
					$season = $row['season'];
					echo "<tr><td>".$serial_no."</a></td>";
					echo "<td><a href='show_match_results.php?season=$season'>".$row['season']."</td>";
					echo "<td>".$row['predicted_winner']."</td></tr>";
				}
			}
			echo "</h3></table>";
			echo "<br><br><u><h3>MATCH WINNER</u><br><br>";
			echo "<table border='2px solid black' padding='20px'><th>Serial No.</th><th>Team 1</th><th>Team 2</th><th>Winner</th>";
			$sql = "SELECT * FROM test1 WHERE user_id='$uid'";
			$result = mysqli_query($conn, $sql);
			$serial_no = 0;
			if(mysqli_num_rows($result) > 0){
				while($row = mysqli_fetch_assoc($result)){
