            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <a href="login.html" class="d-none d-sm-block btn_1 home_page_btn">sign out</a>
                    </nav>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            <h1>Predicting the winner
                                For You</h1>
                            <p>We use the latest technologies to
                                 help you predict the correct winner of the 
                                 whole IPL season and the individual matches.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_pricing_part">
                        ...
                        <a href="#" class="pricing_btn">Preview</a>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_pricing_part">
