...
<body>
	...
	<!-- breadcrumb start-->
	<div class="season">
		<br><br><a class="d-sm-block"><h1>&nbsp;&nbsp;Season winner</h1></a><br>
		<nav class="navbar navbar-expand-lg navbar-light">
		<a href=<?php echo "http://127.0.0.1:5000/season-winner/".$_SESSION['uid']."/2018"?> class="d-none d-sm-block btn_1" width="100px">2018</a>&nbsp;&nbsp;&nbsp;&nbsp;
		<a href=<?php echo "http://127.0.0.1:5000/season-winner/".$_SESSION['uid']."/2019"?> class="d-none d-sm-block btn_1" width="100px">2019</a>&nbsp;&nbsp;&nbsp;&nbsp;
		<a href=<?php echo "http://127.0.0.1:5000/season-winner/".$_SESSION['uid']."/2020"?> class="d-none d-sm-block btn_1" width="100px">2020</a>
	</nav>
</div>
